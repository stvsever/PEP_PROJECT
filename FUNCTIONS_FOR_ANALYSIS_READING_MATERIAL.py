...
def extract_DFU_coefficient(text):
    ...
    Your output only contains ONE integer that is either 0='neutral' or 1='de facto falsifiable'. Output is the following format: "DFU_COEFFICIENT: X". Nothing Else, only the integer. There is a 50% chance to be 'de facto unfalsifiable', and 50% chance to be neutral.
    """
